...
import "./AllHistoryPage.scss";
import { useSelector, useAppDispatch } from "../../redux/hooks";
import DataTable, { createTheme } from 'react-data-table-component';
import { useDate } from '../../context/DateContext';
import { getAllHistory } from '../../redux/allHistory/slice';

export const AllHistoryPage = () => {

  const dispatch = useAppDispatch();
  const history = useSelector((state) => state.allHistory.data);
  const status = useSelector((state) => state.allHistory.status);
